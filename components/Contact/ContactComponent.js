  ...
  return (
    <div className="relative bg-elementC rounded-xl m-10 items-center text-center p-10">
      ...
      <div className="relative justify-center">
        If you have any problem with our site you can fill our ticket belowe we
      ...
      >
        <div className="flex flex-nowrap flex-col pt-10">
          <label className="text-xl font-semibold pb-3 tracking-widest pr-[150px]">
            Email:
          </label>
          <input
            name="email"
          ...
          <label className="text-xl font-semibold pb-3 tracking-widest mt-5 pr-[150px] pt-3">
            Reason:
          </label>
        ...
        <button
          type="submit"
          className="relative bg-red-500 p-3 pl-9 pr-9 rounded-md m-10 font-semibold text-gray-200 transition-colors hover-bg-red-400"
        >
          Submit
        </button>
      </form>
