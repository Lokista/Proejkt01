...
function ProductData({ id , title , description , price, count , image }) {
    ...
    return(
        <div className=" relative flex flex-col m-5 bg-zinc-700 rounded-xl ">
           ...
           <button onClick={addItemToBasket} className=" h-12 rounded-xl bg-red-500 m-4 text-xl font-semibold hover:scale-105 transition-colors duration-700 hover:bg-red-400">
                Add to Basket
           </button>
        </div>
    )
