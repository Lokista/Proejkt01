          ...
          return (
            <div className="flex" key={contact.Miasto}>
              <ul>
                ...
                <li>Miasto: {contact.Miasto}</li>
                <li>Panstwo: {contact.Panstwo}</li>
                <li>Numer: {contact.Telefon}</li>
              ...
              <ul className="pl-5 2xl:pl-48">
                <li>
                  <strong>When Open:</strong>
                </li>
                {contact.Czynne.map((day) => {
                  return (
                    <li key={day.id} className="w-36">
                      {day.id === 6
                        ? `${day.Day}: nieczynne`
                        : `${day.Day}: ${day.od} - ${day.do}`}
                    </li>
                  );
                })}
              </ul>
