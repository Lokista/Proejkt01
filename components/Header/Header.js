    ...
    <header className=" ">
      <div className="bg-elementC flex sticky top-0 z-70 text-red-500 p-2 justify-items-center items-center py-2">
        <div className="flex space-x-3 items-center mr-5 basis-1/7">
          ...
          />
          <Link href="/">
            <a className="hidden sm:flex  link2 ">SHOEP</a>
          </Link>
        </div>
        ...
        <div className="flex rounded-l-md items-center h-10 rounded-r-md cursor-pointer md:flex-auto flex-grow-0  ">
          <input
            ...
            className=" rounded-l-md p-2 h-full flex-shrink focus:outline-none text-black flex-grow"
            type="text"
          />
        ...
        <div className="hidden lg:flex sm:space-x-3 lg:scale-75 xl:scale-100 lg:space-x-3 xl:space-x-12 flex-auto  xl:pl-28">
          <Link href="/">
            <a className={`link2 ${headerComponent.Home}`}>Home</a>
          </Link>
          <Link href="/Shop">
            <a className={` link2 ${headerComponent.Shop}`}>Shop</a>
          </Link>
          <Link href="/Gallery">
            <a className={` link2 ${headerComponent.Gallery}`}>Gallery</a>
          </Link>
          <Link href="/Contact">
            <a className={` link2 ${headerComponent.Contact}`}>Contact</a>
          </Link>
        </div>
      ...
      {isClicked && <MenuObject></MenuObject>}
    </header>
  );
}
